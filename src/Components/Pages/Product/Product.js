...
const Product = () => {
    ...
    // const { sellerLocation } = sellerInformation;
    return (

        <div>
            <h1>Product Details of {_id}</h1>
        </div>
        // <div className="flex items-center overflow-hidden relative">
        //     <div className="w-full rounded bg-white p-4 mx-auto text-gray-800 relative md:text-left">
        ...
        //                     <h4 className='flex items-center gap-x-2'><FaLocationArrow></FaLocationArrow> {sellerLocation}</h4>
